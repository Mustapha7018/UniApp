...
class University(models.Model):
    ...
    type = models.CharField(
        max_length=10, choices=UniversityType.choices, default=UniversityType.PUBLIC
    )
    ...
    location = models.ForeignKey(
        Location, on_delete=models.SET_NULL, null=True, related_name="universities"
    )
...
class AcademicProgram(models.Model):
    ...
    university = models.ForeignKey(
        University, on_delete=models.CASCADE, related_name="academic_programs"
    )
...
class GeneralRequirement(models.Model):
    university = models.ForeignKey(
        University, on_delete=models.CASCADE, related_name="general_requirements"
    )
...
class Resource(models.Model):
    ...
    university = models.ForeignKey(
        University, on_delete=models.CASCADE, related_name="resources"
    )
...
class AboutParagraph(models.Model):
    university = models.ForeignKey(
        University, on_delete=models.CASCADE, related_name="about_paragraphs"
    )
